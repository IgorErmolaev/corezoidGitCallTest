var data = new Object();
data.DATA_LIMIT_DOWN_CATALOGE_DATE = [ new Date('2000-12-12'), new Date() ];
data.DATA_LIMIT_DOWN_CATALOGE_REF = [ '', 'blablabla' ];
data.DATA_LIMIT_DOWN_CATALOGE = [ 'PR2','PR3' ];
data.PROD_CHAR_REFERENCE="blablabla";
...
const CATALOGE_EXCLUDE2=["DOLLARS_CARDS","BLACK","TRG_BLACK","SECONDCARD","FRAUD","REFDOWN",
    "CLIENT_M18","NO RS","MORE THEN 300","MORE THEN HALF","CLOSED PARENT",
    "NEPERED","AGE70","EUROCREDIT","PR1","PR2","TRG_UVOL","SOTR_UVOL",
    "SOTR","UVOL","SPIS_RES","BM","RESTR","CORRECT","SZ","MINLIM300","WAVEDOWN"];
...
data.nodeName = 'limitdown_cataloge';
