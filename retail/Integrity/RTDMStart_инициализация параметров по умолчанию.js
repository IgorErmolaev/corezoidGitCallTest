...
data.rtdm_api_url="http://int-rtdm.ab.loc/RTDMApi";
data.jaguar_url="http://int-rtdm.ab.loc/Jaguar";
...
data.addr_url="https://uaddr.a-bank.com.ua/AddressReference/address/addressInfo.do?";
...
data.lim_or_neg_api_url="https://rmsvc.a-bank.com.ua/service/LimitOrNegative/?type=conv";
...
data.megav_url="https://stat.a-bank.com.ua/stat/api/sasinfo/get/";
/*
...
data.client_prop_url="https://start.a-bank.com.ua:7587/Irbis/dbapi/getclientproperty.xml";
...
data.dict_id = 105435;
/*
data.pyscoring_url = "https://rtdm.kiev.loc/pyscoring";
*/

data.pyscoring_url = "http://int-rtdm.ab.loc/pyscoring";
...
data.rm_url = 'https://rmsvc.a-bank.com.ua';

//data.purse_hbase_url = "https://stat.privatbank.ua/stat/api/purse/module/cards/byekb";
data.purse_hbase_url = "https://stat.a-bank.com.ua/stat/api/purse/module/cards/byekb";

data.actrassr_url = 'https://installments.a-bank.com.ua/InstallmentLoanService/getLoanStateByNrmRef';
