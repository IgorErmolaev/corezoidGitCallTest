...
if (data.RES_DEC_CATEGORY == 'ACCEPT') {
    ...
    if (data.cash_amnisty == 'Y') {
        data.RES_LIMIT_ITOG = Math.max(data.RES_FINAL_KRED_SUM,data.DATA_TRELCLIENTS_FACH_LIM24,data.cash_amnisty_lim);
...
if (data.RES_LIMIT_ITOG>25000) {
    data.RES_LIMIT_ITOG = 25000;
}
